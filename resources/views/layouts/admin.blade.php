    ...
    <div class="page">
            ...
            <div class="navbar-holder d-flex align-items-center justify-content-between">
              ...
              <div class="navbar-header">
                <!-- Navbar Brand --><a href="" class="navbar-brand">
                  <div class="brand-text brand-big"> <img src="{{ asset('img/front.png') }}" alt="" width="170"></div>
                  <div class="brand-text brand-small"> <img src="{{ asset('img/mini.png') }}" alt="" width="50"></div></a>
      ...
      <div class="page-content d-flex align-items-stretch"> 
        ...
        <nav class="side-navbar">
          ...
          <!-- Sidebar Navidation Menus--><span class="heading">Panel de Control</span>
        ...
        @yield('contenido')
          ...
          <footer class="main-footer">
            <div class="container-fluid">
              <div class="row">
                <div class="col-sm-6">
                  <p>Krijosoft &copy; 2017-2019</p>
                </div>
                <div class="col-sm-6 text-right">
                  <p>Design by <a href="https://xiro.net.co" class="external">Krijosoft</a></p>
